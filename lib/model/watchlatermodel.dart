...
//
//     final getWatchlaterModel = getWatchlaterModelFromJson(jsonString);

import 'dart:convert';

GetWatchlaterModel getWatchlaterModelFromJson(String str) =>
    GetWatchlaterModel.fromJson(json.decode(str));

String getWatchlaterModelToJson(GetWatchlaterModel data) =>
    json.encode(data.toJson());

class GetWatchlaterModel {
  int? status;
  String? message;
  List<Result>? result;
  int? totalRows;
  ...
  factory GetWatchlaterModel.fromJson(Map<String, dynamic> json) =>
      GetWatchlaterModel(
        status: json["status"],
