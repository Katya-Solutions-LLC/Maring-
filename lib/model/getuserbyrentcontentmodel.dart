...
//
//     final getUserRentContentModel = getUserRentContentModelFromJson(jsonString);

import 'dart:convert';

GetUserRentContentModel getUserRentContentModelFromJson(String str) =>
    GetUserRentContentModel.fromJson(json.decode(str));

String getUserRentContentModelToJson(GetUserRentContentModel data) =>
    json.encode(data.toJson());

class GetUserRentContentModel {
  int? status;
  String? message;
  List<Result>? result;
  int? totalRows;
  ...
  factory GetUserRentContentModel.fromJson(Map<String, dynamic> json) =>
      GetUserRentContentModel(
        status: json["status"],
