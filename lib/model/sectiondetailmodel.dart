...
SectionDetailModel sectionListModelFromJson(String str) =>
    SectionDetailModel.fromJson(json.decode(str));

String sectionListModelToJson(SectionDetailModel data) =>
...
class Result {
  ...
  factory Result.fromJson(Map<String, dynamic> json) => Result(
        ...
        playlistImage: json["playlist_image"] == null
            ? []
  ...
  Map<String, dynamic> toJson() => {
        ...
        "is_buy": isBuy,
        "stop_time": stopTime,
        "playlist_image": playlistImage == null
            ? []
