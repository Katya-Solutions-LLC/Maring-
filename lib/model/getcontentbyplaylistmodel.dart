...
//
//     final getContentByPlaylistModel = getContentByPlaylistModelFromJson(jsonString);

import 'dart:convert';

GetContentByPlaylistModel getContentByPlaylistModelFromJson(String str) =>
    GetContentByPlaylistModel.fromJson(json.decode(str));

String getContentByPlaylistModelToJson(GetContentByPlaylistModel data) =>
    json.encode(data.toJson());

class GetContentByPlaylistModel {
  int? status;
  String? message;
  List<Result>? result;
  int? totalRows;
  ...
  factory GetContentByPlaylistModel.fromJson(Map<String, dynamic> json) =>
      GetContentByPlaylistModel(
        status: json["status"],
