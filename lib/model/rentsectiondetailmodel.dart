...
//
//     final rentSectionDetailModel = rentSectionDetailModelFromJson(jsonString);

import 'dart:convert';

RentSectionDetailModel rentSectionDetailModelFromJson(String str) =>
    RentSectionDetailModel.fromJson(json.decode(str));

String rentSectionDetailModelToJson(RentSectionDetailModel data) =>
    json.encode(data.toJson());

class RentSectionDetailModel {
  int? status;
  String? message;
  List<Result>? result;
  int? totalRows;
  ...
  factory RentSectionDetailModel.fromJson(Map<String, dynamic> json) =>
      RentSectionDetailModel(
        status: json["status"],
