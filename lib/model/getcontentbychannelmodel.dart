...
//
//     final getContentbyChannelModel = getContentbyChannelModelFromJson(jsonString);

import 'dart:convert';

GetContentbyChannelModel getContentbyChannelModelFromJson(String str) =>
    GetContentbyChannelModel.fromJson(json.decode(str));

String getContentbyChannelModelToJson(GetContentbyChannelModel data) =>
    json.encode(data.toJson());

class GetContentbyChannelModel {
  int? status;
  String? message;
  List<Result>? result;
  int? totalRows;
  ...
  factory GetContentbyChannelModel.fromJson(Map<String, dynamic> json) =>
      GetContentbyChannelModel(
        status: json["status"],
...
class Result {
  ...
  factory Result.fromJson(Map<String, dynamic> json) => Result(
        ...
        playlistImage:
            List<dynamic>.from(json["playlist_image"]?.map((x) => x) ?? []),
      );
