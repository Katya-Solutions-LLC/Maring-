...
//
//     final getMusicByCategoryModel = getMusicByCategoryModelFromJson(jsonString);

import 'dart:convert';

GetMusicByCategoryModel getMusicByCategoryModelFromJson(String str) =>
    GetMusicByCategoryModel.fromJson(json.decode(str));

String getMusicByCategoryModelToJson(GetMusicByCategoryModel data) =>
    json.encode(data.toJson());

class GetMusicByCategoryModel {
  int? status;
  String? message;
  List<Result>? result;
  int? totalRows;
  ...
  factory GetMusicByCategoryModel.fromJson(Map<String, dynamic> json) =>
      GetMusicByCategoryModel(
        status: json["status"],
