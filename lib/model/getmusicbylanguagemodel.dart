...
//
//     final getMusicByLanguageModel = getMusicByLanguageModelFromJson(jsonString);

import 'dart:convert';

GetMusicByLanguageModel getMusicByLanguageModelFromJson(String str) =>
    GetMusicByLanguageModel.fromJson(json.decode(str));

String getMusicByLanguageModelToJson(GetMusicByLanguageModel data) =>
    json.encode(data.toJson());

class GetMusicByLanguageModel {
  int? status;
  String? message;
  List<Result>? result;
  int? totalRows;
  ...
  factory GetMusicByLanguageModel.fromJson(Map<String, dynamic> json) =>
      GetMusicByLanguageModel(
        status: json["status"],
