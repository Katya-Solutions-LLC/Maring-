...
//
//     final getRentContentbyChannel = getRentContentbyChannelFromJson(jsonString);

import 'dart:convert';

GetRentContentbyChannel getRentContentbyChannelFromJson(String str) =>
    GetRentContentbyChannel.fromJson(json.decode(str));

String getRentContentbyChannelToJson(GetRentContentbyChannel data) =>
    json.encode(data.toJson());

class GetRentContentbyChannel {
  int? status;
  String? message;
  List<Result>? result;
  int? totalRows;
  ...
  factory GetRentContentbyChannel.fromJson(Map<String, dynamic> json) =>
      GetRentContentbyChannel(
        status: json["status"],
