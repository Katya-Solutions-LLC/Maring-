...
//
//     final getPlaylistContentModel = getPlaylistContentModelFromJson(jsonString);

import 'dart:convert';

GetPlaylistContentModel getPlaylistContentModelFromJson(String str) =>
    GetPlaylistContentModel.fromJson(json.decode(str));

String getPlaylistContentModelToJson(GetPlaylistContentModel data) =>
    json.encode(data.toJson());

class GetPlaylistContentModel {
  int? status;
  String? message;
  List<Result>? result;
  int? totalRows;
  ...
  factory GetPlaylistContentModel.fromJson(Map<String, dynamic> json) =>
      GetPlaylistContentModel(
        status: json["status"],
