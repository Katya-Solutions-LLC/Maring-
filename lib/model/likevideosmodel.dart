...
//
//     final likeVideosModel = likeVideosModelFromJson(jsonString);

import 'dart:convert';

LikeContentModel likeVideosModelFromJson(String str) =>
    LikeContentModel.fromJson(json.decode(str));

String likeVideosModelToJson(LikeContentModel data) =>
    json.encode(data.toJson());

class LikeContentModel {
  int? status;
  String? message;
  List<Result>? result;
  int? totalRows;
  ...
  factory LikeContentModel.fromJson(Map<String, dynamic> json) =>
      LikeContentModel(
        status: json["status"],
