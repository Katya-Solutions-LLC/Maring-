...
/* Language All Music Fetch Api */
  Future<void> _fetchData(int? nextPage) async {
    debugPrint("isMorePage  ======> ${getMusicByLanguageProvider.isMorePage}");
    debugPrint("currentPage ======> ${getMusicByLanguageProvider.currentPage}");
    debugPrint("totalPage   ======> ${getMusicByLanguageProvider.totalPage}");
